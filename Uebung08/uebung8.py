...
DB = {"user1": {"name": "Jonny Kneubeuller", "email": "jonny.kneubuller@gmail.com", "password":"12345", "username": "user1"},
      "user2":{"name": "Filip Chalapik", "email": "filip.chalapik@gmail.com", "password":"pass123", "username": "user2"},
      "user3":{"name": "Inti Pestoni", "email": "inti.pestoni@gmeil.com", "password":"passwort", "username": "user3"}
      }
